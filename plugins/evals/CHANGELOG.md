...
> **TL;DR (v0.22.0, current — the bundle gains the CODE-TRACKED FACTS: `output_schema` + `tools` on the call-site shard, and a new `pipeline/capabilities.yaml`. Purely additive; grader contract still v9; on-disk schema `0.14.0` → `0.15.0`.)**
