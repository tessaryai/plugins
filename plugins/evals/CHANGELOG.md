...
> **TL;DR (v0.24.0, current — SOP-conformance authoring: two new skills `/evals:derive-sop` + `/evals:reconcile-sop` and a vendored v3 SOP linter. Purely additive; grader contract still v9; on-disk schema still `0.16.0`.)**
