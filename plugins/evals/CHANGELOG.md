...
> **TL;DR (v0.21.0, current — the `--skip-trace-grounding` escape hatch is removed; `publish.py upload` stamps git provenance. BREAKING only for anyone passing the removed flag. Grader contract still v9; on-disk schema still `0.14.0`.)**
