...
> **TL;DR (current — grader contract v9: grader-body lifecycle (deferred → materialized → human-edited), OTel-grounded `expected_spans.source`, three redundant grader fields removed; on-disk schema → `0.13.0`)**
