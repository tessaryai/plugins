...
- Absolute path to the .tessary/ directory.
- The list of call_site IDs and absolute paths to their `.tessary/pipeline/call_sites/<id>.yaml` shards (read each as needed).
