...
```bash
python3 validate.py --bundle .tessary/             # includes pack-resolution + dependency checks
python3 validate.py --bundle .tessary/ --pack security   # filter + compliance-tag matrix
```
