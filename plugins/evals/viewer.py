...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Build a self-contained HTML viewer for an evals/ directory.",
    )
    ap.add_argument("evals_dir", nargs="?", default="evals",
                    help="Path to the evals/ directory (default: ./evals)")
